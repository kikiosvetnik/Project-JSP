    ...
    <div class="collapse navbar-collapse" id="mainNavBar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Logout"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
            ...
            <h4>${poruka}</h4>
            <form class="form-signin" method="GET" action="biranjeNacelnika2.jsp">
                <h2 class="form-signin-heading">Biranje nacelnika</h2>
                <p style="color:red;">${poruka}</p>
                
                <label for="sel1">Ustanova:</label>
                 <select class="form-control" id="sel1" name="idUstanove">
                     <option value="0">-- Izaberi ustanovu --</option>
                <%
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit">Izaberi Nacelnika</button>
            </form>
