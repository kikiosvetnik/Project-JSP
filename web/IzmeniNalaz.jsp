...
<%
            ...
            <form class="form-signin" method="GET" action="IzmeniNalaz">
                <%
                out.println("<input type='hidden' name='idNalaza' value='"+idNalaza+"'>");
                %>
                <h2 class="form-signin-heading">Izmena nalaza:</h2> 
                ...
                <select class="form-control" id="mokraca" name="mokraca">
                    <option value="dobra">Dobra</option>
                    <option value="losa">Losa</option>
                </select>
                <lable for="stolica">Stolica:</lable>
                <select class="form-control" id="stolica" name="stolica">
                    <option value="dobra">Dobra</option>
                    <option value="losa">Losa</option>
                </select>
                <lable for="krvnaSlika">Krvna Slika:</lable>
                <select class="form-control" id="krvnaSlika" name="krvnaSlika">
                    <option value="dobra">Dobra</option>
                    <option value="losa">Losa</option>
                </select>
                <label for="specPregled">Specificni Pregled</label>
                <input class="form-control" type="text" id="specPregled" name="specPregled"></br>
                <button type="submit" class="btn btn-block btn-warning">Izmeni nalaz</button>
            </form>
        </div>
    </body>
    <%        
