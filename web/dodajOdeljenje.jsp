...
<html>
    ...
    <div class="collapse navbar-collapse" id="mainNavBar">
      <ul class="nav navbar-nav ">
        ...
        <li class="active"><a href="dodajOdeljenje.jsp">Odeljenja</a></li>
        <li  class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Logout"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
            ...
            <form class="form-signin" method="GET" action="DodajOdeljenje">
                <h2 class="form-signin-heading">Dodavanje odeljenja</h2>
                <p style="color:red;">${poruka}</p>
                
                <label for="sel1">Ustanova:</label>
                 <select class="form-control" id="sel1" name="nazivUstanove">
                ...
                <label for="inputNaziv">Naziv odeljenja:</label>
                <input id="inputNaziv" type="text" class="form-control" placeholder="Naziv odeljenja" name="naziv" required><br/>
                
                <button class="btn btn-lg btn-primary btn-block" type="submit">Dodaj odeljenje</button>
            </form>
