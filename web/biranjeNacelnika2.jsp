...
<html>
    ...
    <body>
        <div class="container">
            ...
            <%
                String idUstanove = request.getParameter("idUstanove");
            %>
            <form class="form-signin" method="GET" action="biranjeNacelnika3.jsp">
                <h2 class="form-signin-heading">Biranje odeljenje</h2>
                <p style="color:red;">${poruka}</p>

                <label for="sel1">Odeljenje:</label>
                <select class="form-control" id="sel1" name="idOdeljenja">
                    <option value="0">-- Izaberi Odeljenje --</option>
                    <%
                        Connection con = DB.getInstance().getConnection();
                        Statement stmt = con.createStatement();
                        ResultSet rs = stmt.executeQuery("SELECT * FROM odeljenja WHERE id_ustanove='" + request.getParameter("idUstanove") + "'");
                        while (rs.next()) {
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit">Izaberi Odeljenje</button>
            </form>
