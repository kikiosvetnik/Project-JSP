...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h4>${poruka}</h4>
            <form class="form-signin" method="GET" action="PisanjeUputa">
                ...
                %>
                 ...
                 <label for="idLekara">Specijalista kom se upucuje:</label>
                 <select class="form-control" id="idLekara" name="idLekara">
                     <%
                         rs = stmt.executeQuery("SELECT * FROM korisnici WHERE tip_korisnika='specijalista'");
                         while(rs.next()){
                 ...
                 <input type="date" id="datumPregleda" class="form-control" name="datumPregleda" required>
                 <br/>
                 
                <button class="btn btn-lg btn-primary btn-block" type="submit">Napisi uput</button>
            </form>
        </div>
    </body>
